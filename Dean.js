...
function displayTasks() {
    ...
    let tasks = JSON.parse(localStorage.getItem("tasks")) || [];
    tasks.filter(task => task.status === "Waiting").forEach(task => {
...
function displayAcceptedTasks() {
    ...
    let tasks = JSON.parse(localStorage.getItem("tasks")) || [];
    tasks.filter(task => task.status === "Accepted").forEach(task => {
        let listItem = document.createElement("li");
...
function displayDeniedTasks() {
    ...
    let tasks = JSON.parse(localStorage.getItem("tasks")) || [];
    tasks.filter(task => task.status === "Denied").forEach(task => {
        let listItem = document.createElement("li");
